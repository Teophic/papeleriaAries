...
<head>
    ...
    <link rel="icon" href="{{ asset('storage\logos\logo5.png') }}" type="image/png">
    <title>Aries</title>
</head>
    ...
    <header>
        <nav class="navbar sticky-top background-nav" >
            <div class="container-fluid align-items-center">
                <a class="navbar-brand " href="{{URL::to('/')}}" style="width:100px;height:100px;border-radius: 50%"><img src="{{asset('storage\logos\logo5.png') }}" class="" alt="Logo" style="width:100px;height:100px"></a>
